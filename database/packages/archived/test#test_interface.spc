create or replace package test#test_interface is
  ...
  --use log#test_interface.logger.set_env(errors, traces, audits)
  logger app#log := app#log('test#test_interface');
