set serveroutput on;
begin
--test.etl.rebuild_view_ptf_rt_objectagg
    --rebuild the view for polymorphic using typed rowset put and json_objectagg nested source
    oa_dpc_etl.rebuild_etl_view_ptf_rt_objectagg(p_execute => false);
