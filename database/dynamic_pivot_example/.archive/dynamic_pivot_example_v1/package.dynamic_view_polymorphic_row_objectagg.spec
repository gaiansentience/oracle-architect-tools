create or replace package dynamic_view_polymorphic_row_objectagg 
authid current_user
as
/*
...
using dynamic_view_polymorphic_row_objectagg;
*/
...
end dynamic_view_polymorphic_row_objectagg;