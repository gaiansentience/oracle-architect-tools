EXPLAIN PLAN FOR
select /*+ gather_plan_statistics */ * from oa_dpc_etl_json_table_v;
...
Plan hash value: 3798229356
 
-------------------------------------------------------------------------------------------------------------------------------------
| Id  | Operation                 | Name               | Rows  | Bytes |TempSpc| Cost (%CPU)| Time     |    TQ  |IN-OUT| PQ Distrib |
-------------------------------------------------------------------------------------------------------------------------------------
|   0 | SELECT STATEMENT          |                    |   278M|  4294G|       |   222K  (1)| 00:00:09 |        |      |            |
|   1 |  PX COORDINATOR           |                    |       |       |       |            |          |        |      |            |
|   2 |   PX SEND QC (RANDOM)     | :TQ10001           |   278M|  4294G|       |   222K  (1)| 00:00:09 |  Q1,01 | P->S | QC (RAND)  |
|   3 |    NESTED LOOPS           |                    |   278M|  4294G|       |   222K  (1)| 00:00:09 |  Q1,01 | PCWP |            |
...
|  10 |     JSONTABLE EVALUATION  |                    |       |       |       |            |          |  Q1,01 | PCWP |            |
-------------------------------------------------------------------------------------------------------------------------------------
