EXPLAIN PLAN FOR
select /*+ gather_plan_statistics */ * from oa_dpc_etl_ptf_rt_arrayagg_v;
...
-----------------------------------------------------------------------------------------------------------------------------------------
|   0 | SELECT STATEMENT              |                    | 34056 |  3891K|       |   569   (1)| 00:00:01 |        |      |            |
|   1 |  PX COORDINATOR               |                    |       |       |       |            |          |        |      |            |
|   2 |   PX SEND QC (RANDOM)         | :TQ10001           | 34056 |  3891K|       |   569   (1)| 00:00:01 |  Q1,01 | P->S | QC (RAND)  |
|   3 |    POLYMORPHIC TABLE FUNCTION | F                  | 34056 |   535M|       |            |          |  Q1,01 | PCWC |            |
|   4 |     VIEW                      |                    | 34056 |   535M|       |   569   (1)| 00:00:01 |  Q1,01 | PCWP |            |
...
------------------------------------------------------
   ...
   3 - type = row, Read Columns = (JDOC), New Columns  = (area, shading, depth, curvedArea, a_degrees, c_degrees, length, color, circumference, sumInteriorAngles, basePerimeter, side, volume, baseSides, totalSideArea, a_side, radius, slope, composition, b_side, sides, surfaceArea, width, interiorAngles, slantHeight, sideArea, c_side, sideLength, y_intercept, base, baseCircumference, b_degrees, equation, height, baseArea, totalSurfaceArea, lateralArea, baseLength), Pass Through Columns = (ITEM_ID, ITEM_NAME, ITEM_TYPE)
