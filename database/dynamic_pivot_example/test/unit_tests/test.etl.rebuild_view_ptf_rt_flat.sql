set serveroutput on;
begin
--test.etl.rebuild_view_ptf_rt_flat
    --rebuild the view for polymorphic using typed rowset put and json_object flat source
    oa_dpc_etl.rebuild_etl_view_ptf_rt_flat(p_execute => false);
