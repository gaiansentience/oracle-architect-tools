set serveroutput on;
begin
--test.etl.rebuild_view_ptf_ct_arrayagg
    --rebuild the view for polymorphic using typed columns put and json_arrayagg hierarchical source
    oa_dpc_etl.rebuild_etl_view_ptf_ct_arrayagg(p_execute => false);
