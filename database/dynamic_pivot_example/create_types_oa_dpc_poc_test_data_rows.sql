create or replace type oa_dpc_poc_t_value_pair as object(
    value_id   number,
...
create or replace type body oa_dpc_poc_t_value_pair is
    member function get_json return clob
    is
...
create or replace type oa_dpc_poc_t_value_pair_table as table of oa_dpc_poc_t_value_pair;
/

create or replace type oa_dpc_poc_t_row_item as object(
    item_id     number,
    item_name   varchar2(100),
    item_type   varchar2(100),
    item_values oa_dpc_poc_t_value_pair_table,
    member function get_json return clob,
...
create or replace type body oa_dpc_poc_t_row_item is
    member function get_json return clob
    is
    o_doc json_object_t := new json_object_t();
